sap.ui.define(['sap/ui/core/mvc/ControllerExtension','sap/ui/core/Fragment'], function (ControllerExtension,Fragment) {
	...
	return ControllerExtension.extend('mainnotificationui.ext.controller.ExtObject', {
		// this section allows to extend lifecycle hooks or hooks provided by Fiori elements
		override: {
			/**
             * Called when a controller is instantiated and its View controls (if available) are already created.
             * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
             * @memberOf mainnotificationui.ext.controller.ExtObject
             */
			onInit: function () {
		...
		onChat: function() {
			...
			this.fileManagementFragment ??= Fragment.load({
                name: "mainnotificationui.view.Chat"
            });

            this.fileManagementFragment.then(
				
				(oFragment) => oFragment.open()
			
			);

			// this.base.getExtensionAPI().getRouting().navigateToRoute("conversation", {
            //     conversationID: "1312312"
            // });
