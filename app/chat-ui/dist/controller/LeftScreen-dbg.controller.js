sap.ui.define([
    ...
    return Controller.extend("chatui.controller.LeftScreen", {
        ...
        onInit: function(){
            ...
            this.oRouter.getRoute("file").attachPatternMatched(this.onRouteMatched, this);
        },
        ...
        onUploadFileBtnSelect: function(oEvent){
            ...
            this.fileUploadFragment ??= this.loadFragment({
                name: "chatui.view.FileUploading"
            });
        ...
        onManageFileBtnSelect: function(){
            ...
            this.fileManagementFragment ??= this.loadFragment({
                name: "chatui.view.FileManagement"
            });
